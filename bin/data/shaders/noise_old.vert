...
void main(){
	...
	float noiseAmntY = snoise( vec4( pos.x /shaderPerlinFrequency, pos.x /shaderPerlinFrequency,pos.z /shaderPerlinFrequency,timeValY) )*shaderPerlinScale;
    float noiseAmntZ = snoise( vec4( pos.x /shaderPerlinFrequency, pos.y /shaderPerlinFrequency,pos.x /shaderPerlinFrequency,-timeValY) )*shaderPerlinScale;
